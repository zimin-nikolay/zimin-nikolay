...
<img src="./assets/banner.svg" alt="Николай Зимин — C# / .NET Developer" width="100%" />

# Николай Зимин

### C# / .NET Developer

Начинающий разработчик из Красноярска. Создаю настольные приложения, информационные системы, игры и веб-проекты.
...
- **GitHub:** https://github.com/ziminne2006-crypto
